...
<p align="center"> 
<img src="static/flux-edit-replica.png">
</p>
...
6. Let's verify now the amount of replicas in our `app1` namespace:
...
4. In the GitHub UI click in `Add file > Create new file`.
